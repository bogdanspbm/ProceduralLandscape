...
public class BufferTools {
    ...
    /**
     * @param values the byte values that are to be turned into a readable
     * ByteBuffer
     *
    ...
    /**
     * @param matrix4f the Matrix4f that is to be turned into a FloatBuffer that
     * is readable to OpenGL (but not to you)
     *
     * @return a FloatBuffer representation of matrix4f
     */
    ...
    /**
     * @param values the float values that are to be turned into a readable
     * FloatBuffer
     *
